/* this function is to show the logo of the application, more about our application (About, Careers, History, Services, Projects, Blog), how to cntact like by (GitHub, Facebook, Instagram, Twitter, Dribbble)*/
